	...
	const projects = [
		{
			...
			description:
				"Embarking on my first Full-Stack venture, I melded frontend finesse with backend proficiency. Laravel empowered my backend as TailwindCSS enhanced aesthetics. This project marked my gateway into confident frontend craftsmanship.",
			longDescription:
		...
		},
		{
			...
			description:
				"Crafted using PyTube, my Python-based YouTube Downloader empowers users to extract videos in peak quality. Audio-only downloads are also facilitated. This tool showcases my coding finesse alongside user-focused utility.",
			longDescription:
		...
		},
		{
			title: "Zork Game",
			description:
				"Within a C++ academic module, I devised an immersive visual-based adventure. Enthusiasts navigate a virtual realm, engaging with its intricacies. This project exemplifies my fusion of coding acumen with creative ingenuity.",
			longDescription:
		...
		},
		{
			...
			description:
				"Collaboratively, we birthed a machine learning-driven mobile app. Orchestrating frontend finesse through Figma and Android Studio was my forte. This achievement echoes my ability to meld innovation seamlessly with tech.",
			longDescription:
		...
		<NextUIProvider>
			<main className="min-h-screen flex flex-col">
				<div className="flex-grow flex items-center justify-center">
					<motion.div
						className="px-5 py-10 grid grid-cols-1 md:grid-cols-2 gap-5"
						variants={container}
						initial="hidden"
						animate="visible"
					>
